<form action="" method="" id="formulario">
	<fieldset>
		...
		<label class="cadastro" for="repita_email_pessoal">ConfirmaÃ§Ã£o de Email:</label>
		...
		<label  class="cadastro" for="ficcao">FicÃ§Ã£o</label>
	...
	<label  class="endereco" for="endereço" >EndereÃ§o</label>
	<input type="text" id="end" name="endereço" size="50" placeholder="Digite seu Endereço"/>
		
	<label class="endereco" for="numero">NÃºmero</label>
	<input type="text" id="numEnd" name="numero" size="5" placeholder="nº rua"/><br><br>
