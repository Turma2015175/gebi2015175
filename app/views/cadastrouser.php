<form action="" method="" id="formCadastroUsuario">
	<fieldset>
		...
		<label class="cadastro" for="telefone">Telefone:</label>
		<input type="telefone" id="telefone" name="telefone" placeholder="Digite seu Telefone"/>
		

		<label class="cadastro" for="celular">Celular:</label>
		<input type="celular" id="celular" name="celular" placeholder="Digite seu Celular"/><br><br>
		...
		<label class="cadastro" for="login">Login:</label>
		<input type="text" id="login" name="login" placeholder="Informe um Login."/><br><br>
		

		<label class="cadastro" for="senha">Senha:</label>
		<input type="password" id="senha" name="senha" placeholder="Informe uma Senha."/> 

		<label class="cadastro" for="rsenha">Confirmação de Senha:</label>
		<input type="password" id="rsenha" name="rsenha" placeholder="Repita sua Senha."/><br><br>
		
		
		<label>Informe seu género favorito:</label><br>		
		...
		<input type="checkbox" id="terror" name="terror"/>
	...
	<label class="cadastro" for="cep">Cep:</label>
	<input type="text" id="cep" name="cep" placeholder="Digite seu Cep"/>
	
	<label class="cadastro" for="endereco" >Endereço:</label>
	<input type="text" id="end" name="endereco" placeholder="Digite seu Endereço"/>
		
	<label class="cadastro" for="numero">Número:</label>
	<input type="text" id="numEnd" name="numero" placeholder="nº rua"/><br><br>
	
	<label class="cadastro" for="bairro">Bairro:</label>
